...
HP_DROPOUT_MIN = 0.1
HP_DROPOUT_MAX = 0.2
HP_BATCH_SIZE = [16, 32, 64, 128, 256]
HP_LEARNING_RATE = [2e-5, 0.00001, 0.0001, 0.001, 0.01, 0.1]
...
if __name__ == '__main__':
    ...
    def create_and_train_model_for_experiments(trial, train_loader, val_loader, writer):
        ...
        batch_size = trial.suggest_categorical('batch_size', HP_BATCH_SIZE)
        learning_rate = trial.suggest_categorical('learning_rate', HP_LEARNING_RATE)
    ...
    def objective(trial):
        train_loader = DataLoader(train_dataset, batch_size=trial.suggest_categorical('batch_size', [16, 32, 64, 128, 256]), shuffle=True)
